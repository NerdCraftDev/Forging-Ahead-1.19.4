package com.nerdcraftmc.forgingahead.screen;

import com.nerdcraftmc.forgingahead.block.BlockRegistry;
import com.nerdcraftmc.forgingahead.block.entity.ForgeBlockEntity;
...
public class ForgeMenu extends AbstractContainerMenu {
    ...
    public ForgeMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(MenuRegistry.FORGE_MENU.get(), id);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, BlockRegistry.FORGE.get());
    }
